...
The tool is under a major refactoring, and its latest version only offers the tools SCC, CRC and ChC. 
Please, see specific information on the tools for their restrictions and specific use. 
